...
namespace Server.App
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                var iPAddress = IPAddress.Parse("192.168.1.107");

                // initialise listener
                listener = new TcpListener(iPAddress, 8001);
                listener.Start();
                ...
                var bufferSize = socket.Receive(bytes);
